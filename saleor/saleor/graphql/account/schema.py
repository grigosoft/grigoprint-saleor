...
class AccountMutations(graphene.ObjectType):
    ...
    account_update_meta = AccountUpdateMeta.Field(deprecation_reason=(
    ...
    user_update_metadata = UserUpdateMeta.Field(deprecation_reason=(
        "Use the `updateMetadata` mutation. This field will be removed after "
        "2020-07-31."))
    user_clear_metadata = UserClearMeta.Field(deprecation_reason=(
    ...
    user_update_private_metadata = UserUpdatePrivateMeta.Field(
        ...
        ("Use the `updatePrivateMetadata` mutation. This field will be removed "
         "after 2020-07-31."))
    user_clear_private_metadata = UserClearPrivateMeta.Field(deprecation_reason=(
        "Use the `deletePrivateMetadata` mutation. This field will be removed "
        "after 2020-07-31."))

    service_account_create = ServiceAccountCreate.Field(deprecation_reason=(
        "Use the `appCreate` mutation instead. This field will be removed after "
        "2020-07-31."))
    service_account_update = ServiceAccountUpdate.Field(deprecation_reason=(
        "Use the `appUpdate` mutation instead. This field will be removed after "
        "2020-07-31."))
    service_account_delete = ServiceAccountDelete.Field(deprecation_reason=(
